...
const BottleComp = @import("components/Bottle.zig");
...
pub const World = struct {
    ...
    bottle_store: ComponentStore.ComponentStore(BottleComp.Bottle),
    ...
    pub fn init(allocator: std.mem.Allocator) Self {
        return .{
            ...
            .bottle_store = ComponentStore.ComponentStore(BottleComp.Bottle).init(allocator),
        };
    }
